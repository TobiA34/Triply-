    ...
    private func createSmartSuggestions(
        ...
        if let budget = budget {
            let budgetTip = TripSuggestion(
                type: .budget,
                title: "aITripPlanner.budget.optimization".localized,
        ...
        if duration <= 3 {
            suggestions.append(TripSuggestion(
                type: .tip,
                title: "aITripPlanner.short.trip.tips".localized,
            ...
            suggestions.append(TripSuggestion(
                type: .tip,
                title: "aITripPlanner.extended.stay.tips".localized,
        ...
        if interests.contains("culture") {
            suggestions.append(TripSuggestion(
                type: .activity,
                title: "aITripPlanner.cultural.experiences".localized,
        ...
        if interests.contains("adventure") {
            suggestions.append(TripSuggestion(
                type: .activity,
                title: "aITripPlanner.adventure.activities".localized,
    ...
    private func getActivitiesForDestination(_ destination: String, duration: Int) -> [TripSuggestion] {
        ...
        if destinationLower.contains("paris") {
            activities.append(TripSuggestion(
                type: .activity,
                title: "aITripPlanner.eiffel.tower.visit".localized,
            ...
            activities.append(TripSuggestion(
                type: .activity,
                title: "aITripPlanner.shibuya.harajuku".localized,
            ...
            activities.append(TripSuggestion(
                type: .activity,
                title: "aITripPlanner.central.park.museums".localized,
            ...
            activities.append(TripSuggestion(
                type: .activity,
                title: "aITripPlanner.local.exploration".localized,
