...
public struct WishlistViewIOS: View {
    ...
    public init(wishModel: WishModel) {
    ...
    public var body: some View {
        ZStack {
            ...
            if let errorMessage = wishModel.errorMessage, wishModel.hasFetched && !wishModel.isLoading {
                VStack(spacing: 16) {
            ...
            if wishModel.hasFetched && !wishModel.isLoading && wishModel.errorMessage == nil && getList().isEmpty {
